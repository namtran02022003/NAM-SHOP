...
import { MacAir2016, MacAir2017, MacAir2018, MacAir2019, MacAir2020, MacAir2022 } from '../Pages/PageChildren2/index'
import { MacPro2018, MacPro2019, MacPro2020, MacPro2021, MacPro2022 } from '../Pages/PageChildren2/index'
import { MacProM1, MacProM2, MacAirM1, MacAirM2 } from '../Pages/PageChildren2/index'
import { MacBook, ImacDesktop, Iphone, Ipad, AppleWhatch, PhuKien } from "../Pages/PageItem/index.jsx"
import { Imac2015, Imac2017, Imac2019, Imac2020, Imac2021 } from "../Pages/PageChildren2/index"
import { ImacMini2014, ImacMini2018, ImacMini2020 } from "../Pages/PageChildren2/index"
import Cart from "../Pages/Carts/Cart.jsx"
import { Iphone13, Iphone13Pro, Iphone13ProMax, Iphone14, Iphone14Plus, Iphone14Pro, Iphone14ProMax } from "../Pages/PageChildren2/index"
import { AirPods, AirTag, AppleCare, BaLo, BanDiChuot, BanPhim, BanPhimButIpad, BaoDaIpad, BaoDaMacbook, BoDanMacbook, BoVeSinh, CapChuyenDoi, Chuot, DanIpad, DanIphone, ManHinh, OpIphone, OpMacbook, PhanMem, PhuKienTanNhiet, SacIpad, SacIphone, TuiXach } from "../Pages/PageChildren2/index"
import SoSanh from "../Pages/Sosanh/SoSanh.jsx"
import SearchDetail from "../Pages/Search/Search.jsx"
const publicRoutes = [
    { path: '/', component: Home },
    ...
    { path: '/phu-kien-ipad', component: PhuKienIpad },

    { path: '/ban-phim-&-but-ipad', component: BanPhimButIpad },
    { path: '/bao-da-ipad', component: BaoDaIpad },
    { path: '/dan-ipad', component: DanIpad },
    { path: '/sac-ipad', component: SacIpad },
    { path: '/phu-kien-apple-khac', component: PhuKienAppleKhac },
    { path: '/phu-kien-khac', component: PhuKienKhac },
    { path: '/airpods', component: AirPods },
    { path: '/airtag', component: AirTag },
    { path: '/apple-care', component: AppleCare },
    { path: '/ba-lo', component: BaLo },
