...
export default function Cart() {
    ...
    const total = () => {
        return dataCarts.Carts.reduce((a, b) => {
            return (
                a + b.price * b.count + (b.check && (Number(390000) * b.count))
            )
        }, 0);
    };
    const removeCarts = () => {
                ...
                <> {dataCarts.Carts.length > 0 ? <table className='w-100'>
                    <tbody>
                        <tr>
                            ...
                            <th style={{
                                width: "15%"
                            }}>gói bảo hành <span>(+390.000 đ)</span>
                            </th>
                            <th style={{
                                width: "15%"
                            }}>thành tiền
                    ...
                    {showForm && <LoginFormCart totalPrice={total()} datas={dataCarts.Carts} />}</>
            ) : <div>
