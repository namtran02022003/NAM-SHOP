                ...
                <div className="col-4">
                  <div className="position-relative">
                    ...
                    {errors.fullName?.type === "required" && (
                      <p className="text-message-form">
                        Vui lòng nhập đầy đủ họ và tên!
                      </p>
                    )}
                    {errors.fullName?.type === "minLength" && (
                      <p className="text-message-form">
                        Vui lòng nhập tối thiểu 9 kí tự!
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="col-4">
                  <div className="position-relative">
                    ...
                    {errors.addres?.type === "minLength" && (
                      <p className="text-message-form">
                        Vui lòng nhập tối thiểu 12 kí tư!
                      </p>
                    )}
                  </div>
                </div>
                <div className="col-4">
                  <div className="position-relative">
                    ...
                    {errors.note?.type === "required" && (
                      <p className="text-message-form">
                        Vui lòng nhập thông tin địa chỉ cụ thể của bạn!
                      </p>
                    )}
                    {errors.note?.type === "minLength" && (
                      <p className="text-message-form">
                        Vui lòng nhập tối thiểu 12 kí tự!
                      </p>
                    )}
                  </div>
                </div>
                <div className="col-4">
                  <button type="submit" className="btn-dat">
                    Gửi đơn hàng
                  </button>
                </div>
              </div>
